...
<head>
    ...
    <link rel="stylesheet" href="css/AdminAccueil.css">
...
<main class="admin-content">
    <section class="admin-cards">
        <a href="index.php?page=AdminInstallation" class="admin-card">
            <h2>📋 Liste des installations</h2>
            <p>Consultez, modifiez ou ajoutez parmi les données existantes.</p>
        </a>
        <a href="index.php?page=AdminCarte" class="admin-card">
